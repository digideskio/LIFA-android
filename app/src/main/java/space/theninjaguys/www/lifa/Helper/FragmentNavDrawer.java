 ...
 */
public class FragmentNavDrawer extends DrawerLayout {
    ...
    public FragmentNavDrawer(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
    }

    public FragmentNavDrawer(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FragmentNavDrawer(Context context) {
        super(context);
    }
    ...
    public void setupDrawerConfiguration(ListView drawerListView, Toolbar drawerToolbar, int drawerItemRes, int drawerContainerRes) {
        ...
        drawerNavItems = new ArrayList<FragmentNavDrawer.FragmentNavItem>();
